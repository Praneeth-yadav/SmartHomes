...
public class InventoryReport extends HttpServlet {
	...
	HashMap<String, Inventory> allProducts=new HashMap<>();
	HashMap<String, Inventory> onRebateProducts=new HashMap<>();
	HashMap<String, Inventory> onSaleProducts=new HashMap<>();
	...
	protected void doGet(HttpServletRequest request,
		...
		if(CategoryName.equalsIgnoreCase("allproducts"))
		{
		...
		if(CategoryName.equalsIgnoreCase("productsonrebate"))
		{
			pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
		...
		if(CategoryName.equalsIgnoreCase("productsonsale"))
		{
			pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
